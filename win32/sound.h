...
private://private methods
  ...
  static Boolean __stdcall dsEnumCallback(const GUID * lpguid,LPSTR desc,LPSTR Module, LPVOID context);//call back, the context will be a CTypedPtrArrar of GUIDs *
