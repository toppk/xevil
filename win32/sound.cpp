...
SoundManager::init( HWND hwndOwner )
{
	...
	if (DirectSoundEnumerate((int (__stdcall *)(struct _GUID *,char *,char *,void *))&dsEnumCallback,&t_guids))
		return FALSE;
...
BOOL //callback used for enumeration of sound devices.
SoundManager::dsEnumCallback(const GUID * lpguid,LPSTR desc,LPSTR Module, LPVOID context)//call back, the context will be a CTypedPtrArrar of GUIDs *
{
