...
private:
  ...
  static Boolean universal_team(LocatorP,PhysicalP,PhysicalP);
...
private:
  ...
  static Boolean humans_team(LocatorP,PhysicalP,PhysicalP);
  /* EFFECTS: All humans and their slaves are on the same team. */

  static Boolean one_human_team(LocatorP,PhysicalP,PhysicalP);
